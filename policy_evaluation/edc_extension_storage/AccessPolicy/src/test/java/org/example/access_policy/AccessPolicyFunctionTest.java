...
class AccessPolicyFunctionTest {
    ...
    private final AccessPolicyFunction accessPolicyFunction = new AccessPolicyFunction(new ConsoleMonitor());
    ...
    void Validate_EQ_Identity_Success() {
        ...
        ParticipantAgent participantAgent =
                new ParticipantAgent(Map.of(), Map.of("edc:identity", identity));
    ...
    void Validate_EQ_Identity_Failure() {
        ...
        ParticipantAgent participantAgent =
                new ParticipantAgent(Map.of(), Map.of("edc:identity", otherIdentity));
